                                ...
                                <div class="elementor-element elementor-element-a97fdcf elementor-widget elementor-widget-pzy_staff_statistics" data-id="a97fdcf" data-element_type="widget" data-widget_type="pzy_staff_statistics.default">
                                    <div class="elementor-widget-container">
                                        <div class="py-staff-template-information pzy-d-grid">
                                            ...
                                            <div class="py-staff-template-information-card pzy-d-flex pzy-justify-content-between pzy-align-items-center pzy-position-relative">
                                                <div class="pzy-staff-template-information-card-content pzy-d-flex pzy-flex-column-wrap">
                                                    <div class="pzy-staff-template-information-card-title">شبکه های اجتماعی</div>
                                                    <div class="pzy-staff-template-information-card-description">
                                                                ...
                                                                <a class="pzy-share-article-link pzy-share-article-google_plus" target="_blank" href='https://t.me/<%#Eval("dTelegram") %>'>
                                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <g id="vuesax/bold/telegram">
                                                                            <g id="telegram">
                                                                                <path id="Vector" d="M12 0C5.371 0 0 5.371 0 12s5.371 12 12 12 12-5.371 12-12S18.629 0 12 0zm5.556 7.623l-1.888 8.89c-.143.634-.521.788-1.053.49l-2.909-2.148-1.403 1.35c-.155.155-.285.285-.583.285l.208-2.962 5.394-4.873c.234-.208-.051-.324-.364-.116l-6.665 4.186-2.877-.9c-.625-.195-.637-.625.13-.924l11.245-4.33c.521-.195.975.116.779.918z" />
                                                                            </g>
                                                                        </g>
                                                                    </svg>
                                                                </a>
                                                ...
                                                <div class="pzy-staff-template-information-card-shadow pzy-position-absolute">سیشب یسبشی</div>
                                            </div>

                                            <div class="py-staff-template-information-card pzy-d-flex pzy-justify-content-between pzy-align-items-center pzy-position-relative">
                                                <div class="doctor-map">
                                                    <div class="pzy-staff-template-information-card-title">
                                                        موقعیت: 
                                                    </div>
